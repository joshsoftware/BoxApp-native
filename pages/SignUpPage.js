...
const SignUpPage = (props) => {
    ...
    { isLoading ?
      ...
      <>  
        ...
        <Picker mode={'dropdown'} selectedValue={pickerValue} style={styles.cityDropDown} onValueChange={pickerHandler}>
					{datasource.map((item, key) => <Picker.Item label={item.name} value={item.id} key={key} />)}
        </Picker>
